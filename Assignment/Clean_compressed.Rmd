...
ggplot(x, aes(x = age_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "age_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  scale_x_continuous(breaks = seq(min(x$age_clean, na.rm = TRUE), max(x$age_clean, na.rm = TRUE), by = 1)) +
  theme_grey()
```
...
ggplot() + 
  aes(y = reorder(x$country_of_birth_clean, x$country_of_birth_clean, function(x) length(x))) + 
  geom_bar() + 
  labs(y = "", x = "Count") 
...
ggplot(x, aes(x = fluent_languages_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "fluent_languages_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
...
ggplot(x, aes(x = readable_languages_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "readable_languages_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
...
```{r}
unique(sort(x$university_year))
```

```{r}
x <- x |> mutate(university_year = factor(university_year, 
                             levels = c("Fifth or higher year", 
                                        "Fourth year", "Third year", 
                                        "Second year", "First year", NA)))

ggplot(x, aes(x = university_year)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "university_year (%)",
       x = "Option",
       y = "%") +
  theme_grey()
```
...
### enrolled_unit
```{r}
ggplot(x, aes(x = enrolled_unit)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "enrolled_unit (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_grey()
```
...
ggplot(x, aes(x = trimester_or_semester_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "trimester_or_semester_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_grey()
```
...
ggplot(x, aes(x = target_grade)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "target_grade (Perce%ntage)",
       x = "Option",
       y = "%") +
  theme_grey()
...
ggplot(x, aes(x = target_grade)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "target_grade (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_grey()
```
...
```{r}
ggplot(x, aes(x = weekly_study_hours)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "weekly_study_hours (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_grey()
```
...
### assignment_preference
```{r}
ggplot(x, aes(x = assignment_preference)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "assignment_preference (Percentage)",
       x = "Option",
       y = "Percentage") +
...
### assignments_on_time
```{r}
ggplot(x, aes(x = assignments_on_time)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "assignments_on_time (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  theme_grey()
...
### used_r_before
```{r}
ggplot(x, aes(x = used_r_before)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "used_r_before (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  theme_grey()
...
### team_role_type
```{r}
ggplot(x, aes(x = team_role_type)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "team_role_type (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_minimal()
```
...
```{r}
ggplot(x, aes(x = work_status)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "weekly_paid_work_hours? (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_minimal()
```
...
ggplot() + 
  aes(y = reorder(x$diet_style_clean, x$diet_style_clean, function(x) length(x))) + 
  geom_bar() + 
  labs(y = "", x = "Count") 
```
...
ggplot(x, aes(x = tendency_yes_or_no_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "tendency_yes_or_no_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_minimal()
```
...
### urinal_choice, stall_choice

```{r}
# urinal_choice
ggplot(x, aes(x = urinal_choice)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "urinal_choice (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  theme_grey()
...
# stall_choice
ggplot(x, aes(x = stall_choice)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "stall_choice (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  theme_grey()
...
### weetbix_count, weekly_food_spend


```{r}
# weetbix_count
ggplot(x, aes(x = weetbix_count)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "weetbix_count (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  theme_grey()
...
# weekly_food_spend
ggplot(x, aes(x = weekly_food_spend)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "weekly_food_spend (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  theme_grey()
...
```{r}
sort(unique(x$weekly_alcohol))
```


```{r}
x <- x |> 
  mutate(weekly_alcohol_clean = case_when(
    weekly_alcohol %in% c("More than 20 standard drinks") ~ ">20",
    weekly_alcohol %in% c("Between 15 and 20 standard drinks") ~ "15-20",
    weekly_alcohol %in% c("Between 10 and 15 standard drinks") ~ "10-15",
    weekly_alcohol %in% c("Between 5 and 10 standard drinks") ~ "5-10",
    weekly_alcohol %in% c("Less than 5 standard drinks") ~ "<5",
    weekly_alcohol %in% c("I don't drink alcohol") ~ "0",
    TRUE ~ NA_character_  # Handle any unexpected cases
  ))
sort(unique(x$weekly_alcohol_clean))
x <- x |> mutate(weekly_alcohol_clean = factor(weekly_alcohol_clean, 
                             levels = c(">20", 
                                        "15-20",
                                        "10-15",
                                        "5-10",
...
# weekly_food_spend
ggplot(x, aes(x = weekly_alcohol_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "weekly_alcohol_clean",
       x = "Option",
       y = "%") +
...
ggplot() + 
  aes(y = reorder(x$weekly_alcohol_clean, x$weekly_alcohol_clean, function(x) length(x))) + 
  geom_bar() + 
  labs(y = "", x = "Count") 
...
ggplot(x, aes(x = social_media_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "social_media_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_minimal()
```
...
ggplot(x, aes(x = sibling_count_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "sibling_count_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
...
x <- x |> mutate(allergy_count_clean = as.integer(allergy_count_clean))
length(x$allergy_count_clean) # 305

ggplot(x, aes(x = allergy_count_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "allergy_count_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  scale_x_continuous(breaks = seq(min(x$allergy_count_clean, na.rm = TRUE), max(x$allergy_count_clean, na.rm = TRUE), by = 1)) +
  theme_grey()
...
ggplot() + 
  aes(y = reorder(x$favourite_letter_clean, x$favourite_letter_clean, function(x) length(x))) + 
  geom_bar() + 
  labs(y = "", x = "Count") 
...
ggplot(x, aes(x = drivers_license_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "drivers_license_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_minimal()
```
...
ggplot(x, aes(x = relationship_status_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "relationship_status_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_grey()
```
...
ggplot(x, aes(x = steak_preference_clean)) +
  geom_bar(aes(y = (after_stat(count))/sum(after_stat(count))), fill = "skyblue", color = "black") +
  scale_y_continuous(labels = scales::percent_format()) +
  labs(title = "steak_preference_clean (Percentage)",
       x = "Option",
       y = "Percentage") +
  theme_grey()
```
...
cleaned_data <- x |> 
  select(
    ...
    sleep_schedule,            
    weekly_food_spend,          
    weekly_alcohol_clean,         
    daily_anxiety_frequency,   
    social_media_clean,             
    relationship_status_clean,   
    drivers_license_clean,       
   
    # Behavioral and Preference Variables
    sibling_count_clean,        
    allergy_count_clean,        
